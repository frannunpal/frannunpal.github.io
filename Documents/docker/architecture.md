...
[program:api]
command=bun run /app/src/Server/index.ts
...
| -------------- | ---------------------------- | ----------------------------- |
| API command | `bun run src/Server/index.ts`| `bun run dist-server/index.js`|
...
│  │                                                              │
│  ├── api (port 3001)                                            │
│  │   └── bun run /app/src/Server/index.ts                       │
│  │                                                              │
│  ├── watcher                                                    │
│  │   └── Rebuilds apps when ./apps/* changes                    │
│  │                                                              │
...
│  Server bundled with: bun build ./src/Server/index.ts          │
└─────────────────────────────────────────────────────────────────┘
```
