...
Guide for creating and developing React apps in fran-desktop.

## Overview

Apps in fran-desktop are standalone React applications that run inside windows. Each app is compiled independently with its own dependencies.
