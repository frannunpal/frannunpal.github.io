...
**Location**: `src/Presentation/Hooks/useAppUpdate.ts`
...
**Location**: `src/Presentation/Hooks/useDownload.ts`
...
**Location**: `src/Presentation/Hooks/useApplyFont.ts`
...
**Location**: `src/Presentation/Hooks/useLanguageSync.ts`
...
**Location**: `src/Presentation/Hooks/useAppName.ts`
...
**Location**: `src/Presentation/Hooks/useIsDirty.ts`
...
**Location**: `src/Presentation/Hooks/useDynamicIcon.ts` (re-exported from `useFcIcon.ts`)
...
**Location**: `src/Presentation/Hooks/useResolvedUrl.ts`
...
**Location**: `src/Presentation/Hooks/useFolderName.ts`
...
**Location**: `src/Presentation/Hooks/useTaskbarHeight.ts`
...
**Location**: `src/Presentation/Hooks/useSearchFilter.ts`
...
**Location**: `src/Presentation/Hooks/useCollapsible.ts`
...
**Location**: `src/Presentation/Hooks/useDragDrop/`
...
**Location**: `src/Presentation/Hooks/useFdeApi.ts`
...
**Location**: `src/Presentation/Hooks/useJsDos.ts`
...
**Location**: `src/Presentation/Hooks/useDeviceDetection.ts`
...
**Location**: `src/Presentation/Hooks/useAdaptiveDimensions.ts`
...
**Location**: `src/Presentation/Hooks/useTaskbarContextMenu.ts`
...
**Location**: `src/Presentation/Hooks/useFontDownload.ts`
...
**Location**: `src/Presentation/Hooks/useAnimationDuration.ts`
...
**Location**: `src/Shared/Hooks/useCustomAppHMR.ts`
...
**Location**: `src/Shared/Hooks/useMenuBarUtils.ts`
...
**Location**: `src/Presentation/Store/settingsStore.ts`
...
**Location**: `src/Presentation/Store/AppTempMemory.ts`
...
**Location**: `src/Presentation/Store/desktopStore.ts`
