import{n as e}from"./chunk-jRWAZmH_.js";import{X as t,Z as n,wi as r}from"./iframe-DN4_FU3x.js";var i,a,o,s,c,l,u,d;e((()=>{n(),i=r(),a={title:`Shared/UnicodeAnimation`,component:t,parameters:{layout:`centered`},argTypes:{name:{control:`select`,options:[`braille`,`braillewave`,`dna`,`scan`,`rain`,`scanline`,`pulse`,`snake`,`sparkle`,`cascade`,`columns`,`orbit`,`breathe`,`waverows`,`checkerboard`,`helix`,`fillsweep`,`diagswipe`],description:`Spinner animation name from unicode-animations`},style:{control:`object`,description:`Inline styles (merged with monospace font)`},className:{control:`text`,description:`CSS class name`}}},o={args:{name:`braille`}},s={args:{name:`dna`}},c={args:{name:`pulse`}},l={args:{name:`rain`}},u={render:()=>(0,i.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`24px`,fontFamily:`monospace`},children:[`braille`,`braillewave`,`dna`,`scan`,`rain`,`scanline`,`pulse`,`snake`,`sparkle`,`cascade`,`columns`,`orbit`,`breathe`,`waverows`,`checkerboard`,`helix`,`fillsweep`,`diagswipe`].map(e=>(0,i.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,i.jsx)(t,{name:e}),(0,i.jsx)(`div`,{style:{fontSize:`10px`,marginTop:`4px`,color:`#888`},children:e})]},e))})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'braille'
  }
