import{n as e,o as t}from"./rolldown-runtime-DAXXjFlN.js";import{t as n}from"./react-DEAHbL4P.js";import{t as r}from"./jsx-runtime-CFwixLRt.js";import{Ct as i,It as a,Lt as o,St as s,bt as c,d as l,f as u,gt as d,it as f,n as p,r as m}from"./three.module-iqQ2hC7r.js";var h,g,_,v;e((()=>{h=t(n(),1),m(),g=r(),_=4,v=()=>{let e=(0,h.useRef)(null),t=(0,h.useRef)(0);return(0,h.useEffect)(()=>{let n=e.current;if(!n)return;let r=new a,m=new d(-1,1,1,-1,.1,10);m.position.z=1;let h=new p({canvas:n,alpha:!0,antialias:!1}),g=Math.max(n.clientWidth||window.innerWidth,1),v=Math.max(n.clientHeight||window.innerHeight,1);h.setSize(g,v),h.setPixelRatio(1);let y=[],b=new Float32Array(240);for(let e=0;e<80;e++){let t=Math.random(),n=Math.random();y.push({x:t,y:n,size:_*(1+Math.floor(Math.random()*3)),speed:.002+Math.random()*.008,phase:Math.random()*Math.PI*2,alpha:.03+Math.random()*.1}),b[e*3]=t*2-1,b[e*3+1]=n*2-1,b[e*3+2]=0}let x=new u;x.setAttribute(`position`,new l(b,3));let S=new i({color:61695,size:_,transparent:!0,opacity:.15,blending:2,depthWrite:!1,sizeAttenuation:!1}),C=new s(x,S);r.add(C);let w=new c(2,2),T=new o({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uResolution:{value:[n.clientWidth,n.clientHeight]}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
