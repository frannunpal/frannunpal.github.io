...
│  ├─ Full dependencies (@tauri-apps/cli, playwright, testing)    │
│  └─ Used by: development                                       │
│                                                                 │
│  Stage 1b: deps-minimal (oven/bun:1.2)                         │
│  ├─ Filtered dependencies (no tauri cli, playwright, tests)    │
...
| -------------------- | ---------------------------- | ---------- |
| `@tauri-apps/cli`    | Only for native desktop build | ~150MB     |
...
type Runtime = 'browser' | 'docker' | 'tauri';
