# fran-desktop Docker Guide

Quick start guide for running fran-desktop in Docker.
...
If you want to run fran-desktop without building it locally, use the pre-built image from GitHub Container Registry:
