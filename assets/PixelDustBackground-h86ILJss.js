import{a as e,n as t}from"./rolldown-runtime-CNC7AqOf.js";import{i as n,t as r}from"./react-vendor-ChRTX0B8.js";import{Dt as i,Ht as a,Ot as o,Tt as s,Vt as c,a as l,h as u,lt as d,m as f,o as p,xt as m}from"./three-D5LqgIjC.js";var h,g,_,v;t((()=>{h=e(n(),1),p(),g=r(),_=4,v=()=>{let e=(0,h.useRef)(null),t=(0,h.useRef)(0);return(0,h.useEffect)(()=>{let n=e.current;if(!n)return;let r=new c,p=new m(-1,1,1,-1,.1,10);p.position.z=1;let h=new l({canvas:n,alpha:!0,antialias:!1}),g=Math.max(n.clientWidth||window.innerWidth,1),v=Math.max(n.clientHeight||window.innerHeight,1);h.setSize(g,v),h.setPixelRatio(1);let y=[],b=new Float32Array(240);for(let e=0;e<80;e++){let t=Math.random(),n=Math.random();y.push({x:t,y:n,size:_*(1+Math.floor(Math.random()*3)),speed:.002+Math.random()*.008,phase:Math.random()*Math.PI*2,alpha:.03+Math.random()*.1}),b[e*3]=t*2-1,b[e*3+1]=n*2-1,b[e*3+2]=0}let x=new u;x.setAttribute(`position`,new f(b,3));let S=new o({color:61695,size:_,transparent:!0,opacity:.15,blending:2,depthWrite:!1,sizeAttenuation:!1}),C=new i(x,S);r.add(C);let w=new s(2,2),T=new a({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uResolution:{value:[n.clientWidth,n.clientHeight]}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
